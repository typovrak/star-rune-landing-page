...
export default function CardFeature({ icon, iconHover, title, content, className, iconClassName }: ICardFeature) {
	return (
		<Card className={`group/hover border-2 shadow-lg hover:shadow-xl transition-all duration-300 h-full hover:rotate-cta bg-slate-600 hover:bg-slate-700${className ? ` ${className}` : ""}`}>
