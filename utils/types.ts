...
export type TItemClientSourceType =
  | "irl"
  | "discord"
  | "youtube"
  | "kickstarter"
...
export interface IBlockTypingGames {
  id: string;
}

export type TTypingGameButtonType = "steam" | "web";

export interface ITypingGame {
  id: number;
  posterSrc: string;
  posterAlt: string;
  url: string;
  title: string;
  description: string;
  buttonType: TTypingGameButtonType;
  buttonTitle: string;
  buttonColors: string;
  cardColors: string;
  titleColors: string;
